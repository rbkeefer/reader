...
void displayLines(IplImage* inImage, int inWidth, int inMultiplier, list<RkColumn*> inColumnList,
		list<RkColumn*> inExpColumnList, list<RkRow*> inRowList, list<RkRow*> inExpRowList);
...
IplImage* reduceImage(IplImage* inImage, int inWidth, int inMinHeight, int inMinWidth, int inDemoMode)
{
  ...
  // Final Cleanup
//  if (inDemoMode)
//	displayLines(tmpImage, origWidth, origWidth/inWidth, columnList, expandedRkColumnList, rowList, expandedRkRowList);
...
IplImage* reduceImage(IplImage* inImage, int inMinHeight, int inMinWidth, int inDemoMode)
{
  ...
  list<RkColumn*> columnList = findColumns(tmpImage, inMinHeight, WHITE);
  list<RkRow*> rowList = findRows(tmpImage, inMinWidth, WHITE);

  list<RkColumn*> expandedRkColumnList = accelerateColumns(tmpImage, columnList, rowList, WHITE, inMinHeight);
  list<RkRow*> expandedRkRowList = accelerateRows(tmpImage, columnList, rowList, WHITE, inMinWidth);

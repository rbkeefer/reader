...
void testRkUtils(IplImage* origImg) {
	printf("\n** TEST UTILS **\n");
	printf("------------------\n");
	...
	if (! isPointBoundByRectangle(pt1, rect1, 0)) printf("RkUtils: isBoundByRectangle() FAILED\n");
	if (isPointBoundByRectangle(pt2, rect1, 0)) printf("RkUtils: isBoundByRectangle() FAILED\n");
	if (! isPointBoundByRectangle(pt2, rect1, 1)) printf("RkUtils: isBoundByRectangle() FAILED\n");
	...
	if (! isPointBoundByRectangle(pt1, rectList, 0)) printf("RkUtils: isBoundByRectangle() FAILED");
	if (isPointBoundByRectangle(pt2, rectList, 0)) printf("RkUtils: isBoundByRectangle() FAILED");
	if (! isPointBoundByRectangle(pt2, rectList, 1)) printf("RkUtils: isBoundByRectangle() FAILED");
